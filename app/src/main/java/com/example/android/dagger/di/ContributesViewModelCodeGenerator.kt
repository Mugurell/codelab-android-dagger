...
class ContributesViewModelCodeGenerator : CodeGenerator {
                ...
                TypeSpec.classBuilder(moduleClassName)
                    ...
                    .addFunction(
                        FunSpec.builder("bind${vmClass.shortName}Factory")
                            ...
                            .returns(viewModelFactoryPluginFqName.asClassName(module).parameterizedBy(STAR, STAR))
        ...
        val content = FileSpec.buildFile(generatedPackage, assistedFactoryClassName) {
            addType(
                TypeSpec.interfaceBuilder(assistedFactoryClassName)
                    .addSuperinterface(viewModelFactoryPluginFqName.asClassName(module).parameterizedBy(vmClassName, stateClassName))
    ...
    companion object {
        private val viewModelFactoryPluginFqName = FqName("com.example.android.dagger.di.ViewModelFactoryPlugin")
        private val viewModelKeyFqName = FqName("com.example.android.dagger.di.ViewModelKey")
    }
}
